"""One-off: dump bodies of the specific 2026-09-18 sweep hits worth reading.
...
TARGETS = [
    ('from:renaissancecapital.com subject:"Winners and Losers" newer_than:8d', 4500),
    ('from:E-tradeAlerts-DoNotReply@etrade.com subject:"New IPO available" newer_than:6d', 1500),
    ('subject:"Electra" newer_than:2d', 2500),
]
...
def main():
    ...
    for q, cap in TARGETS:
        ...
        for i in ids[-4:]:
            ...
            if subj in seen:      # Gmail duplicates several of these senders
                continue
            seen.add(subj)
            print(f"\n=== {msg.get('Date','')} | {subj}\n")
